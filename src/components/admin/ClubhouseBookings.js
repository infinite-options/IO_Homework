...
const ClubhouseBookings = ({ numBookings, utilization, persons, setTitle, setPersons }) => {
    const handleClick = () => {
        setTitle("Clubhouse");
        setPersons(persons);
    };
            ...
            <Accordion onClick={handleClick} sx={{ marginLeft: "15px", marginRight: "15px", width: "95%" }}>
                <AccordionSummary expandIcon={<img src="arrow.png" alt="expand" />}>
                    <Grid item sx={{ position: "relative", display: "inline-block" }}>
                        <img src="clubhouse.png" alt="clubhouse" style={{ height: "58px" }} />
                    </Grid>
...
export default ClubhouseBookings;
